...
Mp3Encoder::Mp3Encoder(const char* pcmFilePath, const char *mp3FilePath, int sampleRate, int channels, int bitRate){
    this->Init(pcmFilePath, mp3FilePath, sampleRate, channels, bitRate);
}
